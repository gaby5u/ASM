...
const AcquisitionDetails = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Achiziție ASMoldova</title>
        <meta name="description" content={acquisition?.title} />
      </Helmet>
        ...
        <div className="max-w-[1880px] mx-auto">
          ...
          <div className="mt-4 lg:mt-16">
            <h2 className="font-bold text-base mt-6 mb-2 line-clamp-3 lg:text-2xl">
              Trimiteți ofertele până la data de{" "}
            ...
            <p className="text-sm lg:text-lg">
              Subiect email: „{acquisition.emailSubject}"
            </p>
          </div>
        </div>
      </section>
