...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Despre ASMoldova - Educație și implicare civică</title>
        <meta
          name="description"
          content="Află mai multe despre Alianța Studenților din Moldova și proiectele noastre pentru tineri."
        />
      </Helmet>
      <section
