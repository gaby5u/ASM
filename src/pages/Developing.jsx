...
const Developing = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Eveniment în dezvoltare - ASMoldova</title>
        <meta
          name="description"
          content="Evenimentul este în curs de dezvoltare. Revenim curând cu detalii."
        />
      </Helmet>
        ...
        <div className="flex flex-col-reverse items-center justify-between gap-2 my-8 md:flex-row">
          <div className="text-center md:text-start">
            ...
            <p className="my-10 text-base lg:text-2xl">
              Momentan acest eveniment este în proces de pregătire. Lucrăm la
              detalii și vom reveni în curând cu mai multe informații!
            </p>
            <BlueButton
              text="Înapoi"
              className="px-10"
          ...
          <img
            ...
            alt="calendar"
            className="max-w-[260px] lg:max-w-[360px] xl:max-w-[575px]"
          />
        </div>
      </section>
    </>
